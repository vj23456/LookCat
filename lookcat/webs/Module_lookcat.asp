	...
	if(dbus["lookcat_enable"] == "1"){
		...
		if (hostname.indexOf('.kooldns.cn') != -1 || hostname.indexOf('.gd.ddnsto.com') != -1 || hostname.indexOf('.x.ddnsto.com') != -1 || hostname.indexOf('.ddnsto.com') != -1 || hostname.indexOf('.tocmcc.cn') != -1) {
			...
			if(hostname.indexOf('.kooldns.cn') != -1){
				...
				hostname = hostname.replace('.gd.ddnsto.com','-cat.gd.ddnsto.com');
			}else if(hostname.indexOf('.x.ddnsto.com') != -1){
				hostname = hostname.replace('.x.ddnsto.com','-cat.x.ddnsto.com');
...
function menu_hook(title, tab) {
	tabtitle[tabtitle.length - 1] = new Array("", "lookcat_");
	tablink[tablink.length - 1] = new Array("", "Module_lookcat.asp");
}
